...
public class ObjectFactory {
    ...
    private final static QName _ValidateInvoice_QNAME = new QName("http://services.nda.or.ug", "validateInvoice");
    private final static QName _ValidateInvoiceResponse_QNAME = new QName("http://services.nda.or.ug", "validateInvoiceResponse");
    private final static QName _PaymentNotificationResponse_QNAME = new QName("http://services.nda.or.ug", "paymentNotificationResponse");
    private final static QName _PaymentNotification_QNAME = new QName("http://services.nda.or.ug", "paymentNotification");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.nda.or.ug", name = "validateInvoice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.nda.or.ug", name = "validateInvoiceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.nda.or.ug", name = "paymentNotificationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.nda.or.ug", name = "paymentNotification")
